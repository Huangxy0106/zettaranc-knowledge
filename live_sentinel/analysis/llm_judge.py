...
预期收益与所承受的风险、持仓心态、市场周期、公司市值与盈利模式等讨论同样属于投资分析，
不能因没有说出“投资”一词而漏判。Apple Speech 转写可能有错字、断句和口头禅，
应按可辨认的上下文判断，但不能凭猜测补出片段中不存在的投资观点。
如果主播用体育、游戏或产品作类比来解释投资与产业判断，应结合明确说出的结论评估；
即使结论集中在片段末尾，也不要只按前面的类比或闲聊评分。纯粹的类比闲聊仍应低分。
聊茶叶、汽车购买、相亲、体育或卖货本身，即使出现“市场”“价格”“行业”等词，
如果没有连到投资、产业或宏观判断，应低分；一带而过、广告或缺乏可辨识观点也应低分。
